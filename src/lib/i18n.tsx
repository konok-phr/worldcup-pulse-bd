...
export const DICT: Dict = {
  ...
  nav_statistics: { en: "Statistics", bn: "পরিসংখ্যান" },
  ...
  filter_search_teams: { en: "Search teams or countries...", bn: "দল বা দেশ খুঁজুন..." },
  filter_all_dates: { en: "All Dates", bn: "সব তারিখ" },
  filter_today: { en: "Today's Matches", bn: "আজকের ম্যাচ" },
  filter_by_stage: { en: "Filter by Stage", bn: "পর্ব অনুযায়ী ফিল্টার" },
  no_filtered_matches: { en: "No matches found matching your filters.", bn: "আপনার ফিল্টারের সাথে মিলে এমন কোনো ম্যাচ পাওয়া যায়নি।" },
